...
public extension DataStore.Object {
    @propertyWrapper final class Reference<Enclosing, Value>: ReferenceStorage where Value: ObjectStore.Object, Enclosing: DataStore.Object {
        ...
        public static subscript(_enclosingInstance instance: Enclosing,
                                ...
                                storage storageKeyPath: ReferenceWritableKeyPath<Enclosing, Reference>) -> Value?
        {
            get {
