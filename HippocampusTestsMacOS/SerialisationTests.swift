...
//        print("\(uuid) = '\(x1)'")
//        
//        let normalData = try! JSONEncoder().encode(uuid)
////        print("\(normalData.count) /  \(data.count)")
//        XCTAssert(normalData.count > data.count)
//        
////        print("\(String(data: normalData, encoding: .utf8)) /  \(String(data: data, encoding: .utf8))")
//        
//        let uuid2 = UUID(key: x1)
//        print ("\(uuid2)")
...
//    
//   
//    func testUUIDStringsMultiple() throws {
//        for i in 0 ..< 1000 {
//            print (i)
//            try testUUIDStrings()
//        }
