...
extension Structure {
    indirect enum Presentation: Structure.PersistentValue {
        ...
        case empty
        case undefined
        case horizontal([Presentation], alignment: Alignment = Alignment.top)
        case vertical([Presentation], alignment: Alignment = Alignment.leading)
        ...
        static func aspect(_ aspect: Structure.Aspect, form: String, editable: Bool = true) -> Presentation {
        ...
        static func vertical(_ children: Presentation..., alignment: Alignment = .leading) -> Presentation {
