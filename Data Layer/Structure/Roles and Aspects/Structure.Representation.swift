...
extension Structure {
    indirect enum Representation {
        ...
        case aspect(Structure.Aspect, form: Structure.Aspect.Presentation.Form, editable: Bool = true)
        ...
        func view(for item: Information.Item, editable: Bool) -> some View {
            ...
            case let .aspect(aspect, form, isEditable):
                aspect.view(for: item, as: form, editable: isEditable && editable)
            }
        }
    }
